...
function actions.build()
    ...
    local ember  = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                print(string.format("%s usou Brasas e deu %d pontos de dano", playerData.name,  damage))
     ...
     local slash = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Corte e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    local flamethrower  = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Lança-chamas e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    -- Populate list
    actions.list[#actions.list + 1] = ember
    actions.list[#actions.list + 1] = slash
    actions.list[#actions.list + 1] = flamethrower
