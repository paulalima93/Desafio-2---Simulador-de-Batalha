...
function actions.build()
    ...
    local bubble  = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                print(string.format("%s usou Bolha e deu %d pontos de dano", playerData.name,  damage))
     ...
     local waterGun = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Jato de Água e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    local hydroPump = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Hidro Bomba e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    -- Populate list
    actions.list[#actions.list + 1] = bubble
    actions.list[#actions.list + 1] = waterGun
    actions.list[#actions.list + 1] = hydroPump
