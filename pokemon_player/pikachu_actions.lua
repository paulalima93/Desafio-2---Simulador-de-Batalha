...
function actions.build()
    ...
    local thunderbolt = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                print(string.format("%s usou Choque do Trovão e deu %d pontos de dano", playerData.name,  damage))
     ...
     local quickAttack = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Ataque Rápido e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    local thunder = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Raio e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    -- Populate list
    actions.list[#actions.list + 1] = thunder
    actions.list[#actions.list + 1] = quickAttack
    actions.list[#actions.list + 1] = thunderbolt
