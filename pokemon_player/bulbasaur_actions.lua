...
function actions.build()
    ...
    local vineWhip = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                print(string.format("%s usou Chicote de Vinha e deu %d pontos de dano", playerData.name,  damage))
     ...
     local razorLeaf = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Folha Navalha e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    local solarBeam = {
        ...
        execute = function(playerData, creatureData)
            ...
            if success then
                ...
                -- 4. Apresentar resultado como print
                print(string.format("%s usou Raio Solar e deu %d pontos de dano", playerData.name,  damage))
                local healthRate = math.floor((creatureData.health / creatureData.maxHealth) * 10)
                print(string.format("%s: %s", creatureData.name, utils.getProgressBar(healthRate)))
    ...
    -- Populate list
    actions.list[#actions.list + 1] = vineWhip
    actions.list[#actions.list + 1] = razorLeaf
    actions.list[#actions.list + 1] = solarBeam
